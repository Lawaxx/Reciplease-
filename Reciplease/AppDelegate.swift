...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    lazy var coreDataStack = CoreDataStack(modelName: "RecipeData")
...
// ici j'ai pas fait comme Ambroise, j'ai retiré toute la partie CoreData et je l'ai mis dans un autre fichier
